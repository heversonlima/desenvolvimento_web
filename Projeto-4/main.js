...
function greetingHandler() {
  ...
  let condicoesFarh = `The weather is cloudy in ${userLocal} and it's ${celciusToFarh(
    temperatura
  )}°F outside.`;
...
function localTime() {
  ...
  setInterval(function () {
    ...
    document.querySelector("span[data-time=hours]").textContent = horaLocal
      .getHours()
      .toString()
      .padStart(2, "0");
    document.querySelector("span[data-time=minutes]").textContent = horaLocal
      .getMinutes()
      .toString()
      .padStart(2, "0");
    document.querySelector("span[data-time=seconds]").textContent = horaLocal
      .getSeconds()
      .toString()
      .padStart(2, "0");
  }, 1000);
